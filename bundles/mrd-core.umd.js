(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('underscore'), require('rxjs'), require('@angular/forms'), require('moment')) :
    typeof define === 'function' && define.amd ? define('mrd-core', ['exports', 'rxjs/operators', 'underscore', 'rxjs', '@angular/forms', 'moment'], factory) :
    (global = global || self, factory(global['mrd-core'] = {}, global.rxjs.operators, global.underscore, global.rxjs, global.ng.forms, global.moment));
}(this, (function (exports, operators, underscore, rxjs, forms, moment) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SubscriptionManager = /** @class */ (function () {
        ...
        function (name, observable, handler) {
            ...
            function () {
                ...
                if (underscore.isFunction(handler.onFinished)) {
            ...
            function () {
                ...
                if (underscore.isFunction(handler.onSuccess)) {
            ...
            function () {
                ...
                if (underscore.isFunction(handler.onError)) {
    ...
    var Util = /** @class */ (function () {
        ...
        function (url, queryParams) {
            if (!queryParams || underscore.isEmpty(queryParams)) {
                return url;
            }
            underscore.each(queryParams, (/**
             * @param {?} value
             * @param {?} key
             * @return {?}
             */
        ...
        function (list, attribute) {
            var _this = this;
            /** @type {?} */
            var resultList = underscore.sortBy(list, (/**
             * @param {?} item
             * @return {?}
             */
    ...
    ItemStore = /** @class */ (function () {
        function ItemStore(identifier, transform) {
            ...
            this.onChanged = new rxjs.Subject();
            this.items$ = {};
    ...
    RestHandler = /** @class */ (function () {
        ...
        function (id, getParams, httpOptions) {
            ...
            return this.http.delete(Util.armUrlWithSearchParams(Util.createEntityUrl(this.url, id), getParams), httpOptions).pipe(operators.tap((/**
             * @return {?}
             */
            function () {
        ...
        function (model, getParams, httpOptions) {
            ...
            return this.http.patch(Util.armUrlWithSearchParams(Util.createEntityUrl(this.url, model[this.identifier]), getParams), model, httpOptions).pipe(operators.tap((/**
             * @param {?} result
             * @return {?}
             */
            function (result) {
        ...
        function (model, getParams, httpOptions) {
            ...
            observable = this.http.put(Util.armUrlWithSearchParams(this.url, getParams), model, httpOptions).pipe(operators.tap((/**
             * @param {?} result
             * @return {?}
             */
            function (result) {
        ...
        function (model, getParams, httpOptions) {
            var _this = this;
            this.observer.isUpdatingItem = true;
            return this.http.put(Util.armUrlWithSearchParams(Util.createEntityUrl(this.url, model[this.identifier]), getParams), model, httpOptions).pipe(operators.tap((/**
             * @param {?} result
             * @return {?}
             */
            function (result) {
    ...
    BaseObject = /** @class */ (function () {
        ...
        function (observable, handler) {
            return observable
                .pipe(operators.takeUntil(this.$unsubscribe), operators.finalize((/**
             * @param {...?} args
             * @return {?}
             */
            function () {
    ...
    var ValidatorRequired = /** @class */ (function () {
         ...
         */
        function () {
            if (underscore.isDate(this.value)) {
                this.hasError = false;
                return null;
            }
            ...
            if (underscore.isNumber(this.value)) {
                this.hasError = false;
                return null;
            }
            if (underscore.isString(this.value)) {
            ...
            if (underscore.isBoolean(this.value)) {
                this.hasError = false;
                return null;
            }
            if (!this.value || underscore.isEmpty(this.value)) {
                this.hasError = true;
                return { required: true };
            }
            else {
    ...
    AccessableFormControl = /** @class */ (function () {
        ...
        function (formState, validators) {
            this.control = new forms.FormControl(formState, null, null);
        ...
        function (validators) {
            ...
            this.control.setValidators(underscore.map(validators, (/**
             * @param {?} v
             * @return {?}
             */
            function (v) {
            ...
            this.required$ = false;
            underscore.each(this.validators$, (/**
             * @param {?} v
             * @return {?}
             */
            function (v) {
        ...
        Object.defineProperty(AccessableFormControl.prototype, "error", {
             ...
             */
            function () {
                return underscore.find(this.validators$, (/**
                 * @param {?} v
                 * @return {?}
                 */
    ...
    AccessableFormGroup = /** @class */ (function () {
         ...
         */
        function (fields) {
            this.control = new forms.FormGroup(underscore.mapObject(fields, (/**
             * @param {?} field
             * @return {?}
             */
            function (field) {
    ...
    AccessableFormArray = /** @class */ (function () {
         ...
         */
        function (type) {
            this.control = new forms.FormArray([]);
            this.type = type;
            this.entries$ = [];
        };
        /**
        ...
        function (index) {
            ...
            this.entries$ = underscore.reject(this.entries$, (/**
             * @param {?} e
             * @param {?} round
             * @return {?}
             */
        ...
        function (validators) {
            ...
            if (underscore.isArray(validators)) {
                this.validators$ = validators;
            }
            this.control.setValidators(underscore.map(validators, (/**
             * @param {?} v
        ...
        Object.defineProperty(AccessableFormArray.prototype, "errors", {
             ...
             */
            function () {
                return underscore.compact(underscore.map(this.validators$, (/**
                 * @param {?} e
                 * @return {?}
                 */
                function (e) {
    ...
    ReadonlyRestServiceObserver = /** @class */ (function () {
        function ReadonlyRestServiceObserver() {
            this.onItemFetched = new rxjs.Subject();
            this.onItemsFetched = new rxjs.Subject();
    ...
    RestServiceObserver = /** @class */ (function (_super) {
        ...
        function RestServiceObserver() {
            var _this = _super.call(this) || this;
            _this.onItemCreated = new rxjs.Subject();
            _this.onItemUpdated = new rxjs.Subject();
            _this.onItemDestroyed = new rxjs.Subject();
            _this.onItemPartialUpdated = new rxjs.Subject();
            _this.onItemSaved = new rxjs.Subject();
    ...
    TypeConverter = /** @class */ (function () {
        ...
        function (value) {
            ...
            if (underscore.isString(value) && REGEX.NUMBER.test((/** @type {?} */ (value)))) {
        ...
        function (value, stellen) {
            ...
            if (!underscore.isUndefined(stellen) && underscore.isNumber(value)) {
        ...
        function (text) {
            /** @type {?} */
            var builderString = '';
            if (underscore.isEmpty(text)) {
                return new RegExp(builderString);
            }
            underscore.each(text.split(''), (/**
             * @param {?} char
             * @return {?}
             */
            function (char) {
    ...
    AbstractStoredRestservice = /** @class */ (function (_super) {
        ...
        function (observable) {
            var _this = this;
            return observable.pipe(operators.tap((/**
             * @param {?} result
             * @return {?}
             */
            function (result) {
    ...
    AbstractActivationQueuedGuard = /** @class */ (function () {
        ...
        function (level, subscriber) {
            ...
            /** @type {?} */
            var activators = underscore.map(currentQueueItems, (/**
             * @param {?} queueItem
             * @return {?}
             */
            function (queueItem) {
            ...
            SubscriptionManager.subscribe(rxjs.forkJoin(activators), new SubscriptionHandler((/**
             * @param {?} canActivateStates
             * @return {?}
             */
            function (canActivateStates) {
                if (!underscore.all(canActivateStates)) {
    ...
    AbstractRouteConfiguration = /** @class */ (function () {
        ...
        Object.defineProperty(AbstractRouteConfiguration.prototype, "paramDefinition", {
             ...
             */
            function () {
                return underscore.extend(Util.isDefined(this.parent) ? this.parent.paramDefinition : {}, this.paramNames || {});
            },
            enumerable: true,
            configurable: true
        });
        ...
        function (params) {
            ...
            navigationParams = navigationParams.concat(underscore.map(this.pathSegments, (/**
             * @param {?} segment
             * @return {?}
             */
            function (segment) {
    ...
    BaseRootComponent = /** @class */ (function (_super) {
        ...
        function () {
            ...
            underscore.each(this.observables, (/**
             * @param {?} observable
             * @return {?}
             */
    ...
    AbstractReadonlyCachedRestservice = /** @class */ (function (_super) {
        ...
        function (searchParams, httpOptions) {
            if (this.store.isStoreValid()) {
                return rxjs.of(this.store.items);
            }
            else {
        ...
        function (id, getParams, httpOptions) {
            if (this.store.isItemValid(id)) {
                ...
                return rxjs.of(underscore.find(this.store.items, lookup));
            }
    ...
    AbstractEntityResolver = /** @class */ (function () {
        ...
        function (activatedRoute, params) {
            /** @type {?} */
            var currentRouteParams = underscore.extend(underscore.clone(activatedRoute.snapshot.params), params);
    ...
    var TimestampItemStore = /** @class */ (function (_super) {
        ...
        function () {
            ...
            if (underscore.isEmpty(this.items)) {
                return false;
            }
            return underscore.all(this.items, (/**
             * @param {?} item
             * @return {?}
             */
    ...
    exports.AbstractActivationGuard = AbstractActivationGuard;
    exports.AbstractActivationQueuedGuard = AbstractActivationQueuedGuard;
    exports.AbstractCachedRestservice = AbstractCachedRestservice;
    exports.AbstractEntityResolver = AbstractEntityResolver;
    exports.AbstractReadonlyCachedRestservice = AbstractReadonlyCachedRestservice;
    exports.AbstractReadonlyRestservice = AbstractReadonlyRestservice;
    exports.AbstractResolver = AbstractResolver;
    exports.AbstractRestservice = AbstractRestservice;
    exports.AbstractRouteConfiguration = AbstractRouteConfiguration;
    exports.AbstractStoredReadonlyRestservice = AbstractStoredReadonlyRestservice;
    exports.AbstractStoredRestservice = AbstractStoredRestservice;
    exports.AccessableControlFactory = AccessableControlFactory;
    exports.AccessableFormArray = AccessableFormArray;
    exports.AccessableFormControl = AccessableFormControl;
    exports.AccessableFormGroup = AccessableFormGroup;
    exports.BaseObject = BaseObject;
    exports.BasePushStrategyObject = BasePushStrategyObject;
    exports.BaseRootComponent = BaseRootComponent;
    exports.DeactivationHandler = DeactivationHandler;
    ...
    exports.TimestampItemStore = TimestampItemStore;
    exports.TypeConverter = TypeConverter;
    exports.Util = Util;
    exports.ValidatorCustom = ValidatorCustom;
    exports.ValidatorEmail = ValidatorEmail;
    exports.ValidatorFixedValue = ValidatorFixedValue;
    exports.ValidatorFloat = ValidatorFloat;
    exports.ValidatorInteger = ValidatorInteger;
    exports.ValidatorPostalCode = ValidatorPostalCode;
    exports.ValidatorRequired = ValidatorRequired;
    exports.ɵa = RestServiceObserver;
    exports.ɵb = ReadonlyRestServiceObserver;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=mrd-core.umd.js.map
